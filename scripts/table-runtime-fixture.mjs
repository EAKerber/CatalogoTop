...
const runtimeFiles=['src/table-block.js','src/table-document.js','src/table-render.js','src/table-controls.js','src/product-actions.js','src/product-delete-ui.js','src/block-overlap-guard.js','src/catalog-renderer.js'];
...
const names=['index.html','src/table-block.js','src/table-document.js','src/table-render.js','src/table-controls.js','src/product-actions.js','src/product-delete-ui.js','src/block-overlap-guard.js','src/catalog-document.js','src/catalog-renderer.js','src/collection-controls.js','src/print.js','table-block.css','docs/table-block-v0.10.2.md'];
...
['UI Table não usa MutationObserver',files['src/table-controls.js'].includes('Agrupar em tabela')&&!files['src/table-controls.js'].includes('MutationObserver')],
