...
try {
  ...
  if (emptyDesktop.previewHeight < 730 || emptyDesktop.previewOverflowY !== 'auto' || emptyDesktop.previewRangeY < 160) throw new Error(`A4 não recebeu território vertical suficiente após reflow da toolbar: ${JSON.stringify(emptyDesktop)}`);
