...
const checks = [
  ...
  ['estado local migra para schema v7', core.includes('SCHEMA_VERSION = 7') && core.includes('imageGallery: normalizeImageGallery') && core.includes('order: []') && core.includes('blocks: []')],
