...
const checks = [
  ...
  ['presets de conteúdo incluem auto, visual, técnico e comercial', composition.includes("id: 'auto'") && composition.includes("id: 'visual'") && composition.includes("id: 'technical'") && composition.includes("id: 'commercial'")],
