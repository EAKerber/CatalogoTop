...
const requiredFiles = [
  ...
  'editorial-composition.css','catalog-page.css','composer-layout.css','preview-viewport.css','contextual-inspector.css','grouping-controls.css','editorial-selection-table.css','print.css',
...
const names = [
  'index.html','shell-responsive.css','mobile-header.css','editorial-composition.css','catalog-page.css','composer-layout.css','preview-viewport.css','contextual-inspector.css','grouping-controls.css','editorial-selection-table.css','print.css','collection-block.css','table-block.css',
...
const checks = [
  ...
  ['GroupingControls deriva candidatos da seleção editorial sem estado paralelo', groupingControls.includes('ComposerSelection?.ids') && groupingControls.includes('candidateIds') && groupingControls.includes('catalogotop:grouping-selection-changed') && !groupingControls.includes('const markedIds = new Set()') && !groupingControls.includes("let mode = 'browse'") && !groupingControls.includes('Core.mutate')],
  ...
  ['print continua isolado com CSS documental completo', printJs.includes("querySelectorAll('.catalog-page')") && printJs.includes('collection-block.css') && printJs.includes('table-block.css') && printJs.includes('editorial-selection-table.css')],
  ...
  ['chrome do inspector é editor-only', files['contextual-inspector.css'].includes('#catalogPreview .editor-selected') && files['editorial-selection-table.css'].includes('@media print')],
