...
const runtimeFiles=['src/collection.js','src/collection-document.js','src/collection-render.js','src/collection-controls.js','src/catalog-renderer.js'];
...
const [html,core,composition,model,documentAdapter,renderer,controls,orderBootstrap,catalogDocument,catalogRenderer,css,docs]=await Promise.all([
'index.html','src/core.js','src/composition.js','src/collection.js','src/collection-document.js','src/collection-render.js','src/collection-controls.js','src/catalog-selection-order.js','src/catalog-document.js','src/catalog-renderer.js','collection-block.css','docs/collection-block-v0.10.1.md'].map(readFileUtf8));
function readFileUtf8(file){return readFile(file,'utf8');}
const checks=[
['estado local preserva blocks',core.includes('SCHEMA_VERSION = 4')&&core.includes('blocks: []')],
...
['UI Collection não usa MutationObserver',controls.includes('Agrupar em coleção')&&controls.includes('data-collection-member-width')&&!controls.includes('MutationObserver')],
